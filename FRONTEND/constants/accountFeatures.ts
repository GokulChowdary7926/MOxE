/**
 * Shared feature definitions for MOxE accounts.
 * Frontend companion to BACKEND/src/constants/capabilities.ts.
 *
 * We separate:
 * - common/basic features (MOxE Basic for everyone)
 * - per-account-type feature groups (Personal, Business, Creator, Job)
 */
...
/** Features that are part of MOxE Basic and exist for all account types. */
...
/** Additional feature groups by account type (over and above MOxE Basic). */
