...
type MoxePageHeaderProps = {
  ...
  onBack?: () => void;
  /** @deprecated Dark only; ignored. */
  variant?: 'dark' | 'light';
  className?: string;
};

/**
 * MOxE social-style page header (mobile).
 * - Centered title
 * - Left: Back/Cancel
 * - Right: Settings/Post/Custom actions
 */
export function MoxePageHeader({
  title,
  left,
  right,
  backTo,
  ...
  void variant;
  const bg = 'bg-black border-b border-[#262626]';
