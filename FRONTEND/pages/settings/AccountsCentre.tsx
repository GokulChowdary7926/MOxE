      ...
      <MobileShell>
        ...
        <div className="flex-1 overflow-auto pb-20">
          ...
          <p className="text-[#a8a8a8] text-sm px-4 pb-6 text-center">
            Manage your connected experiences and account settings across MOxE technologies such as Facebook, Instagram and Meta Horizon. <span className="text-[#0095f6]">Learn more</span>
          </p>
