    ...
    <ThemedView className="min-h-screen flex flex-col bg-black">
      <MobileShell>
        <header className="sticky top-0 z-10 flex items-center h-12 px-3 border-b border-[#262626] bg-black safe-area-pt">
          ...
          <span className="flex-1 text-center text-white font-semibold">Posts</span>
          <div className="w-10" />
        </header>
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-6 py-12">
          ...
          <h2 className="text-white font-semibold text-xl text-center mb-2">You haven&apos;t posted anything</h2>
          <p className="text-[#a8a8a8] text-sm text-center">
            When you create a post, it&apos;ll appear here.
          </p>
        </div>
      </MobileShell>
    </ThemedView>
